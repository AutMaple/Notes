...
设计模式是对大家实际工作中写的各种代码进行高层次抽象的总结，其中最出名的当属

Gang of Four(GoF) 的分类了，他们将设计模式分类为 23 种经典的模式，根据用途我们又可以分为三大类，分别为**创建型模式、结构型模式和行为型模式**

- 创造型模式: 用于描述 “怎样创建对象”，它的主要特点是 “将对象的创建与使用分离”。GoF 中提供了单例、原型、工厂方法、抽象工厂、建造者等 5 种创建型模式。
...
设计模式要活学活用，不要生搬硬套。设计模式的目的都是让程序低耦合，高复用，高内聚，易扩展，易维护。
...
![factory-1](/home/autmaple/Documents/Notes/Attachment/1668ac9a05f8e190tplv-t2oaga2asx-zoom-in-crop-mark1304000.webp)
...
![factory-1](/home/autmaple/Documents/Notes/Attachment/1668ac9a05de67a4tplv-t2oaga2asx-zoom-in-crop-mark1304000.webp)
...
![abstract-factory-2](/home/autmaple/Documents/Notes/Attachment/1668ac9a066f8810tplv-t2oaga2asx-zoom-in-crop-mark1304000.webp)

当涉及到这种产品族的问题的时候，就需要抽象工厂模式来支持了。我们不再定义 CPU 工厂、主板工厂、硬盘工厂、显示屏工厂等等，我们直接定义电脑工厂，每个电脑工厂负责生产所有的设备，这样能保证肯定不存在兼容问题。

![abstract-factory-3](/home/autmaple/Documents/Notes/Attachment/1668ac9a0665ea60tplv-t2oaga2asx-zoom-in-crop-mark1304000.webp)
...
前面创建型模式介绍了创建对象的一些设计模式，这节介绍的结构型模式旨在**通过改变代码结构来达到解耦的目的，使得我们的代码容易维护和扩展。**
...
![proxy](/home/autmaple/Documents/Notes/Attachment/1668ac9a05ed0c11tplv-t2oaga2asx-zoom-in-crop-mark1304000.webp)
...
![adapter-1](/home/autmaple/Documents/Notes/Attachment/1668ac9a06753244tplv-t2oaga2asx-zoom-in-crop-mark1304000.webp)
...
![adapter-1](/home/autmaple/Documents/Notes/Attachment/1668ac9a06512b0ctplv-t2oaga2asx-zoom-in-crop-mark1304000.webp)
...
2. 适配器模式和代理模式的异同
   ...
   ![adapter-5](/home/autmaple/Documents/Notes/Attachment/1668ac9a06d8cfb2tplv-t2oaga2asx-zoom-in-crop-mark1304000.webp)
...
![bridge-1](/home/autmaple/Documents/Notes/Attachment/1668ac9a07119726tplv-t2oaga2asx-zoom-in-crop-mark1304000.webp)

这回大家应该就知道抽象在哪里，怎么解耦了吧。桥梁模式的优点也是显而易见的，就是非常容易进行扩展。

> 本节引用了[这里](https://link.juejin.cn/?target=https%3A%2F%2Fwww.tutorialspoint.com%2Fdesign_pattern%2Fbridge_pattern.htm)的例子，并对其进行了修改。
...
![decorator-1](/home/autmaple/Documents/Notes/Attachment/1668ac9a076dbb49tplv-t2oaga2asx-zoom-in-crop-mark1304000.webp)
...
> 从名字来简单解释下装饰器。既然说是装饰，那么往往就是**添加小功能**这种，而且，我们要满足可以添加多个小功能。最简单的，代理模式就可以实现功能的增强，但是 **代理不容易实现多个功能的增强**，当然你可以说用代理包装代理的方式，但是那样的话代码就复杂了。
...
![decorator-2](/home/autmaple/Documents/Notes/Attachment/1668ac9a077cd10dtplv-t2oaga2asx-zoom-in-crop-mark1304000.webp)

到这里，大家应该已经清楚装饰模式了吧。

下面，我们再来说说 java IO 中的装饰模式。看下图 InputStream 派生出来的部分类：

![decorator-3](/home/autmaple/Documents/Notes/Attachment/1668ac9a072fcc13tplv-t2oaga2asx-zoom-in-crop-mark1304000.webp)
...
![strategy-1](/home/autmaple/Documents/Notes/Attachment/1668ac9a07775812tplv-t2oaga2asx-zoom-in-crop-mark1304000.webp)
